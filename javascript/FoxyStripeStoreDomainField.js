/**
 * based on SiteTreeURLSegmentField.js
 */
(function ($) {
    $.entwine('fs', function ($) {
        /**
         * Class .field.foxystripestoredomain
         */
        $('.field.foxystripestoredomain:not(.readonly)').entwine({
            ...
            redraw: function () {
                ...
                this.find('.preview').attr('href', encodeURI(url)).text(previewUrl);
            },
            /**
             * @param Boolean
             */
        ...
        $('.field.foxystripestoredomain .edit').entwine({
            onclick: function (e) {
                e.preventDefault();
        ...
        $('.field.foxystripestoredomain .update').entwine({
            onclick: function (e) {
                e.preventDefault();
        ...
        $('.field.foxystripestoredomain .cancel').entwine({
            onclick: function (e) {
                e.preventDefault();
