...
class OptionItem extends DataObject
{
    ...
    public function getCMSFields()
    {
        ...
        $groupField = DropdownField::create('ProductOptionGroupID', _t("OptionItem.Group", "Group"), $groups())
            ->setEmptyString('')
            ->setDescription(_t('OptionItem.GroupDescription',
                'Name of this group of options. Managed in <a href="admin/settings">Settings > FoxyStripe > Option Groups</a>'));
        ...
        $fields->addFieldsToTab('Root.Main', array(
            ...
            CheckboxField::create('Available')
                ...
                ->setDescription(_t('OptionItem.AvailableDescription',
    ...
    /**
     * @param $oma
     * @param bool|false $returnWithOnlyPlusMinus
     * @return string
     */
    ...
    public function getGeneratedTitle()
    {
        $modPrice = ($this->PriceModifier) ? (string)$this->PriceModifier : '0';
        $title = $this->Title;
        $title .= ($this->PriceModifier != 0) ? ': (' . OptionItem::getOptionModifierActionSymbol($this->PriceModifierAction,
                $returnWithOnlyPlusMinus = true) . '$' . $modPrice . ')' : '';
        return $title;
    }
